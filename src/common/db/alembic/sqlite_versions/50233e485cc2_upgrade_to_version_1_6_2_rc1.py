...
Revision ID: 50233e485cc2
Revises: 78db0feeb89a
Create Date: 2025-03-20 11:43:38.840229
...
revision: str = "50233e485cc2"
down_revision: Union[str, None] = "78db0feeb89a"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("suffix", sa.Integer(), nullable=True, server_default="0"),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), sa.Identity(start=1, increment=1), nullable=False),
        sa.Column("setting_id", sa.String(256), nullable=False),
        sa.Column("value", sa.String(256), nullable=True, server_default=""),
    ...
    op.create_table(
        ...
        sa.Column("default", sa.Text(), nullable=True, server_default=""),  # Changed nullable=True here
        sa.Column("suffix", sa.Integer(), nullable=True, server_default="0"),
        sa.Column("order", sa.Integer(), nullable=False, server_default="0"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("user_agent", sa.Text(), nullable=True, server_default=""),  # Changed nullable=True here
