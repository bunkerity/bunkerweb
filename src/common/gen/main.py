...
if __name__ == "__main__":
    try:
        ...
        # Remove old files. iterdir(), not glob("*"), so dotfiles go too: a regenerated output
        # directory must not keep an entry of the previous render that a glob cannot see.
