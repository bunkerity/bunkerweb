...
function remove() {
    ...
    # /etc, /var/lib, /var/log, /var/backups/bunkerweb preserved (Debian Policy §10.8).
    ...
    echo "ℹ️ Preserved (use 'apt-get purge bunkerweb' to delete configs + data): /etc/bunkerweb, /var/lib/bunkerweb"
    print_leftover_hint
}
