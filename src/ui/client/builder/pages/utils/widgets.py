...
def advanced_widget(
    template: dict, containerClass: str = "", operation: str = "edit", oldServerName: str = "", columns: dict = {"pc": "12", "tablet": "12", "mobile": "12"}
):
    """
    ...
    list_params = [
        ...
        ("columns", columns, {"pc": "12", "tablet": "12", "mobile": "12"}),
    ]
...
def button_group_widget(buttons: list, boutonGroupClass: str = ""):
    """
...
def cell_widget(type: str, data: dict):
    """
...
def checkbox_widget(
    ...
    -   `tabId` **(String | Number)** The tabindex of the field, by default it is the contentIndex (optional, default `contentIndex`)
    -   `hideFeedbackError` **Boolean** If field should be validate and show error. Useful to disable it for filters. (optional, default `false`)
    ...
    list_params = [
        ("id", id, ""),
        ("attrs", attrs, None),
        ("popovers", popovers, None),
        ("inpType", inpType, "checkbox"),
        ("disabled", disabled, False),
        ...
        ("inpClass", inpClass, ""),
        ("fieldSize", fieldSize, "normal"),
        ("tabId", tabId, ""),
        ("hideFeedbackError", hideFeedbackError, False),
    ]
    for param in list_params:
        add_key_value(data, param[0], param[1], param[2])
...
def clipboard_widget(id: str = "", isClipboard: bool = False, valueToCopy: str = "", clipboadClass: str = "", copyClass: str = "", fieldSize: str = "normal"):
    """
    ...
    list_params = [
        ("id", id, ""),
        ("isClipboard", isClipboard, False),
        ("valueToCopy", valueToCopy, ""),
        ("clipboadClass", clipboadClass, ""),
        ("copyClass", copyClass, ""),
        ("fieldSize", fieldSize, "normal"),
    ]
    for param in list_params:
...
def combobox_widget(
    ...
    list_params = [
        ("id", id, ""),
        ("attrs", attrs, None),
        ("maxBtnChars", maxBtnChars, ""),
        ("popovers", popovers, None),
        ("inpType", inpType, "select"),
        ("disabled", disabled, False),
        ("required", required, False),
        ("requiredValues", requiredValues, None),
        ("columns", columns, {"pc": "12", "tablet": "12", "mobile": "12"}),
        ("hideLabel", hideLabel, False),
        ("onlyDown", onlyDown, False),
        ("overflowAttrEl", overflowAttrEl, ""),
        ("containerClass", containerClass, ""),
        ("inpClass", inpClass, ""),
        ("fieldSize", fieldSize, "normal"),
        ("headerClass", headerClass, ""),
...
def container_widget(
    containerClass: str = "", columns: Union[dict, bool] = {"pc": "12", "tablet": "12", "mobile": "12"}, tag: str = "div", display: Optional[list] = None
):
    """
...
def datepicker_widget(
    ...
    list_params = [
        ...
        ("popovers", popovers, None),
        ("attrs", attrs, None),
        ("inpType", inpType, "datepicker"),
        ("value", value, ""),
        ("minDate", minDate, ""),
        ("maxDate", maxDate, ""),
        ("isClipboard", isClipboard, True),
        ("hideLabel", hideLabel, False),
        ("columns", columns, {"pc": "12", "tablet": "12", "mobile": "12"}),
        ("disabled", disabled, False),
        ("required", required, False),
...
def details_widget(columns, details: str, filters: Optional[list] = None):
    """
...
def fields_widget(setting: dict):
    """
...
def filter_widget(filters: Optional[list] = None, data: Union[dict, list] = {}, containerClass: str = ""):
    """
...
def grid_widget(gridClass: str = "items-start", display: Optional[list] = None):
    """
    This component is a basic container that can be used to wrap other components.
...
def grid_layout_widget(
    ...
    list_params = [
        ...
        ("link", link, ""),
        ("columns", columns, {"pc": 12, "tablet": 12, "mobile": 12}),
        ("gridLayoutClass", gridLayoutClass, "items-start"),
        ("display", display, None),
        ("tabId", tabId, ""),
        ("maxWidthScreen", maxWidthScreen, "2xl"),
    ]
    for param in list_params:
        add_key_value(data, param[0], param[1], param[2])
...
def icons_widget(value, iconName: str, iconClass: str = "base", color: str = "", isStick: bool = False, disabled: bool = False):
    """
...
def multiple_widget(multiples: dict, columns: dict = {"pc": "12", "tablet": "12", "mobile": "12"}, containerClass: str = "", tadId: str = ""):
    """
...
def pairs_widget(pairs: list, columns: dict = {"pc": "12", "tablet": "12", "mobile": "12"}):
    """
...
def popover_widget(
    text: str, color: str, href: str = "#", attrs: Optional[dict] = None, tag: str = "a", iconClass: str = "icon-default", tabId: Union[str, int] = ""
):
    """
...
def popover_group_widget(popovers: list, groupClasss: str = ""):
    """
...
def raw_widget(
    template: dict, operation: str = "edit", oldServerName: str = "", containerClass: str = "", columns: dict = {"pc": "12", "tablet": "12", "mobile": "12"}
):
    """
...
def regular_widget(
    ...
    list_params = [
        ("containerClass", containerClass, ""),
        ("endpoint", endpoint, ""),
        ("maxWidthScreen", maxWidthScreen, "lg"),
        ("columns", columns, {"pc": "12", "tablet": "12", "mobile": "12"}),
    ]
    for param in list_params:
        add_key_value(data, param[0], param[1], param[2])
...
def stat_widget(title: str, stat: Union[str, int], subtitle: str = "", iconName: str = "", subtitleColor: str = "info"):
    """
...
def status_widget(id: str, status: str = "info", statusClass: str = ""):
    """
...
def table_widget(
    ...
    list_params = [
        ...
        ("minWidth", minWidth, "base"),
        ("containerClass", containerClass, ""),
        ("containerWrapClass", containerWrapClass, ""),
...
def tabulator_widget(
    ...
    list_params = [
        ...
        ("filters", filters, None),
        ("actionsButtons", actionsButtons, None),
        ("layout", layout, "fitDataTable"),
        ("rowHeight", rowHeight, 0),
        ("colMinWidth", colMinWidth, 150),
        ("colMaxWidth", colMaxWidth, 0),
        ("isPagination", isPagination, True),
        ("itemsBeforePagination", itemsBeforePagination, 10),
        ("paginationSize", paginationSize, 10),
        ("paginationInitialPage", paginationInitialPage, 1),
        ("paginationSizeSelector", paginationSizeSelector, [10, 25, 50, 100]),
    ]
    for param in list_params:
        add_key_value(data, param[0], param[1], param[2])
...
def templates_widget(templates: dict, operation: str = "edit", oldServerName: str = ""):
    """
...
def title_widget(title: str, type: str = "card", tag: str = "", color: str = "", uppercase: bool = False, lowercase: bool = False, titleClass: str = ""):
    """
...
def unmatch_widget(text: str, unmatchClass: str = ""):
    """
