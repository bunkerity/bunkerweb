...
def clipboard_widget(id: str = "", isClipboard: bool = False, valueToCopy: str = "", clipboadClass: str = "", copyClass: str = ""):
    """
...
def field_widget(label: str, id: str, name: str, popovers: Optional[list] = None, required: bool = False, hideLabel: bool = False, headerClass: str = ""):
    """
