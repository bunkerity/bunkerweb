      ...
      >
        ...
        >
          <div role="row" class="list-content-item-wrap">
            <div role="cell" :class="[addPositions[0], 'mr-2']">
              <SettingsLayout
                :showLabel="false"
            ...
            <div role="cell" :class="[addPositions[1], 'mr-2']">
              <SettingsLayout
                :showLabel="false"
            ...
            <div role="cell" :class="[addPositions[2], 'mr-2']">
              <SettingsLayout
                :showLabel="false"
            ...
            <div role="cell" :class="[addPositions[3], 'mr-2']">
              <SettingsLayout
                :showLabel="false"
