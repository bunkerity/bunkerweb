      ...
      <div class="col-span-12 flex flex-col items-center justify-center mt-6">
        <div class="flex justify-center items-center">
          <ButtonBase
            ...
            type="button"
            class="text-sm"
            :disabled="addBans.isPend ? true : false"
          ...
          <ButtonBase
            ...
            :aria-disabled="bans.items.length > 0 ? 'true' : 'false'"
            :disabled="
              bans.items.length > 0 ? (addBans.isPend ? true : false) : true
            "
            color="valid"
            size="lg"
            class="w-fit text-sm ml-2"
            :isLoading="addBans.isPend"
            type="submit"
