<script setup>
import FileManagerButtonView from "../../FileManager/Button/View.vue";
import FileManagerButtonEdit from "../../FileManager/Button/Edit.vue";
import FileManagerButtonDownload from "../../FileManager/Button/Download.vue";
import FileManagerButtonDelete from "../../FileManager/Button/Delete.vue";
