<script setup>
import FileManagerModal from "../FileManager/Modal.vue";
import FileManagerActions from "../FileManager/Actions.vue";
import FileManagerBreadcrumb from "../FileManager/breadcrumb.vue";
import FileManagerContainer from "../FileManager/Container.vue";
import FileManagerItemBase from "../FileManager/Item/Base.vue";
