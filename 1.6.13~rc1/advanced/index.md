...
Many real-world use case examples are available in the [examples](https://github.com/bunkerity/bunkerweb/tree/v1.6.13-rc1/examples) folder of the GitHub repository.

We also provide numerous boilerplates, such as YAML files for various integrations and database types. These are available in the [misc/integrations](https://github.com/bunkerity/bunkerweb/tree/v1.6.13-rc1/misc/integrations) folder.
...
=== "Linux"
    ...
    1. **Download and run the installer** on the manager host:
        ...
        curl -fsSL -O https://github.com/bunkerity/bunkerweb/releases/download/v1.6.13-rc1/install-bunkerweb.sh
        curl -fsSL -O https://github.com/bunkerity/bunkerweb/releases/download/v1.6.13-rc1/install-bunkerweb.sh.sha256
...
=== "Docker"
    ...
    services:
      ...
      bw-ui:
        image: bunkerity/bunkerweb-ui:1.6.13-rc1
        ports:
...
=== "Docker autoconf"
    ...
    services:
      ...
      bw-autoconf:
        image: bunkerity/bunkerweb-autoconf:1.6.13-rc1
        depends_on:
          - bunkerweb
          - bw-docker
        environment:
...
A complete example is available in [`examples/mcp-stack/`](https://github.com/bunkerity/bunkerweb/tree/v1.6.13-rc1/examples/mcp-stack):
