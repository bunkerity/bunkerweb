...
!!! info "Going further"
    ...
    You will find concrete examples of multisite mode in the [advanced usages](https://docs.bunkerweb.io/latest/advanced/) of the documentation and the [examples](https://github.com/bunkerity/bunkerweb/tree/v1.6.14/examples) directory of the repository.
...
!!! info "Going further"
    ...
    You will find concrete examples of custom configurations in the [advanced usages](https://docs.bunkerweb.io/latest/advanced/#custom-configurations) of the documentation and the [examples](https://github.com/bunkerity/bunkerweb/tree/v1.6.14/examples) directory of the repository.
