...
- Component agent guides:
  - [src/api/AGENTS.md](src/api/AGENTS.md) ([details](src/api/CLAUDE.md))
  - [src/ui/AGENTS.md](src/ui/AGENTS.md) ([details](src/ui/CLAUDE.md))
  - [src/scheduler/AGENTS.md](src/scheduler/AGENTS.md) ([details](src/scheduler/CLAUDE.md))
  - [src/autoconf/AGENTS.md](src/autoconf/AGENTS.md) ([details](src/autoconf/CLAUDE.md))
  - [src/bw/AGENTS.md](src/bw/AGENTS.md) ([details](src/bw/CLAUDE.md))
  - [src/worker/AGENTS.md](src/worker/AGENTS.md) ([details](src/worker/CLAUDE.md))
  - [src/common/AGENTS.md](src/common/AGENTS.md) ([details](src/common/CLAUDE.md))
  - [src/linux/AGENTS.md](src/linux/AGENTS.md) ([details](src/linux/CLAUDE.md))
  - [src/all-in-one/AGENTS.md](src/all-in-one/AGENTS.md) ([details](src/all-in-one/CLAUDE.md))
  - [examples/mcp-stack/AGENTS.md](examples/mcp-stack/AGENTS.md) ([details](examples/mcp-stack/CLAUDE.md))
