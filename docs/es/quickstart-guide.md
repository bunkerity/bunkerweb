...
Consulta la [carpeta de ejemplos](https://github.com/bunkerity/bunkerweb/tree/v1.6.10-rc6/examples) del repositorio para obtener ejemplos del mundo real.
...
=== "Linux"
    ...
    - Dos flags controlan la TUI: `--no-tui` (o `BW_INSTALL_TUI=no`) salta todos los niveles de TUI y usa indicaciones de texto plano; `--tui` exige una TUI operativa y aborta si ni gum ni whiptail pueden instalarse.
