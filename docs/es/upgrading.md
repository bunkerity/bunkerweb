...
=== "Actualización fácil usando el script de instalación"
    ...
    *  **Opciones de línea de comandos**:
        ...
        ```bash
        # Actualizar a 1.6.8~rc1 interactivamente (pedirá confirmación para la copia de seguridad)
        ...
        - Actualiza BunkerWeb a la última versión.
            ...
            2. **Actualizar BunkerWeb**:
                ...
                === "Debian/Ubuntu"
                    ...
                    ```shell
                    sudo apt update && \
                    sudo apt install -y --allow-downgrades bunkerweb=1.6.8~rc1
                    ```
                ...
                === "Fedora/RedHat"
                    ...
                    ```shell
                    sudo dnf makecache && \
                    sudo dnf install -y --allowerasing bunkerweb-1.6.8~rc1
                    ```
