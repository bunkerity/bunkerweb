...
| Opción                  | Descripción                                                                                             |
| :---------------------- | :------------------------------------------------------------------------------------------------------ |
| `-v, --version VERSION` | Especifica la versión de BunkerWeb a instalar (p. ej., `1.6.15~rc3`).                                   |
...
=== "Debian Bookworm/Trixie"
    ...
    Y finalmente instala BunkerWeb 1.6.15~rc3:
...
=== "Fedora"
    ...
    !!! warning "Fedora 43 incluye NGINX 1.30.4"
        Fedora 43 aún no proporciona NGINX 1.30.5, por lo que el paquete de BunkerWeb para Fedora 43 se compila contra NGINX 1.30.4 y espera `nginx-1.30.4`. Instala esa versión en Fedora 43; la fijación pasará a 1.30.5 en cuanto Fedora 43 la publique. Fedora 44 ya proporciona 1.30.5.
...
En lugar de usar el chart de Helm, también puedes usar las plantillas YAML dentro de la [carpeta misc/integrations](https://github.com/bunkerity/bunkerweb/tree/v1.6.15-rc3/misc/integrations) del repositorio de GitHub. Ten en cuenta que recomendamos encarecidamente usar el chart de Helm en su lugar.
