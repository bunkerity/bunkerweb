...
2.  **Fournir un e-mail de contact :** Saisissez votre adresse e-mail dans le paramètre `EMAIL_LETS_ENCRYPT` pour recevoir les notifications importantes concernant vos certificats.
