...
Consultez le [dossier examples](https://github.com/bunkerity/bunkerweb/tree/v1.6.10-rc6/examples) du dépôt pour obtenir des exemples concrets.
...
=== "Linux"
    ...
    - Deux drapeaux contrôlent la TUI : `--no-tui` (ou `BW_INSTALL_TUI=no`) saute tous les niveaux de TUI et utilise les invites en texte brut ; `--tui` exige une TUI fonctionnelle et abandonne si ni gum ni whiptail ne peuvent être installés.
