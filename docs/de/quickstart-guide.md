...
Im [Beispielordner](https://github.com/bunkerity/bunkerweb/tree/v1.6.10-rc6/examples) des Repositorys finden Sie Beispiele aus der Praxis.
...
=== "Linux"
    ...
    - Zwei Flags steuern die TUI: `--no-tui` (oder `BW_INSTALL_TUI=no`) überspringt alle TUI-Ebenen und verwendet einfache Texteingaben; `--tui` erfordert eine funktionierende TUI und bricht ab, wenn weder gum noch whiptail installiert werden können.
