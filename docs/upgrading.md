        ...
        === "Linux"
            ...
            4. **Update BunkerWeb**:
                ...
                === "Debian/Ubuntu"
                    ...
                    ```shell
                    sudo apt install -y bunkerweb=1.5.12
                    ```
                ...
                === "Fedora/RedHat"
                    ...
                    ```shell
                    sudo dnf install -y bunkerweb-1.5.12
                    ```
