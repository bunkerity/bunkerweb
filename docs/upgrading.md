        ...
        === "Linux"
            ...
            4. **Update BunkerWeb**:
                ...
                === "Debian/Ubuntu"
                    ...
                    ```shell
                    sudo apt install -y bunkerweb=1.6.0-rc3
                    ```
                ...
                === "Fedora/RedHat"
                    ...
                    ```shell
                    sudo dnf install -y bunkerweb-1.6.0-rc3
                    ```
