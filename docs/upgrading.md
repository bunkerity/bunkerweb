        ...
        === "Linux"
            ...
            4. **Update BunkerWeb**:
                ...
                === "Debian/Ubuntu"
                    ...
                    ```shell
                    sudo apt install -y bunkerweb=1.5.11
                    ```
                ...
                === "Fedora/RedHat"
                    ...
                    ```shell
                    sudo dnf install -y bunkerweb-1.5.11
                    ```
