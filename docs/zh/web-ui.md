...
=== "Docker"
    ...
    !!! info "数据库后端"
        ...
        如果您想要一个除 MariaDB 之外的数据库后端，请参阅仓库的 [misc/integrations 文件夹](https://github.com/bunkerity/bunkerweb/tree/v1.6.6-rc2/misc/integrations)中的 docker-compose 文件。
...
=== "Kubernetes"
    ...
    !!! info "数据库后端"
        ...
        如果您想要一个除 MariaDB 之外的数据库后端，请参阅仓库的 [misc/integrations 文件夹](https://github.com/bunkerity/bunkerweb/tree/v1.6.6-rc2/misc/integrations)中的 yaml 文件。
...
=== "Swarm"
    ...
    !!! info "数据库后端"
        ...
        如果您想要一个除 MariaDB 之外的数据库后端，请参阅仓库的 [misc/integrations 文件夹](https://github.com/bunkerity/bunkerweb/tree/v1.6.6-rc2/misc/integrations)中的堆栈文件。
...
有关翻译来源和审核状态的详细信息，请参阅 [locales/README.md](https://github.com/bunkerity/bunkerweb/raw/v1.6.6-rc2/src/ui/app/static/locales/README.md)。
...
有关完整指南，请参阅 [locales/README.md](https://github.com/bunkerity/bunkerweb/raw/v1.6.6-rc2/src/ui/app/static/locales/README.md)。
