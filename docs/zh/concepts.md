...
!!! info "更进一步"
    ...
    您将在文档的[高级用法](advanced.md)和仓库的 [examples](https://github.com/bunkerity/bunkerweb/tree/v1.6.12/examples) 目录中找到多站点模式的具体示例。
...
!!! info "更进一步"
    ...
    您将在文档的[高级用法](advanced.md#custom-configurations)和仓库的 [examples](https://github.com/bunkerity/bunkerweb/tree/v1.6.12/examples) 目录中找到自定义配置的具体示例。
