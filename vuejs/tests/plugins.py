...
def plugins_builder(plugins, data={}):
    is_readonly = data.get("readonly", False)
    is_pro_version = data.get("is_pro_version", False)
    ...
    for plugin in plugins:
        ...
        if plugin.get("page", False):
            plugin_detail["popovers"].append(
                {
...
output = plugins_builder(plugins_data)

with open("plugins_page.json", "w") as f:
